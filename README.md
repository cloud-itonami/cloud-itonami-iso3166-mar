# cloud-itonami-iso3166-mar

Open ISO 3166 Blueprint for **MAR**: Morocco.
...
tax registration, and local-content rules in Morocco, so the operator
...
- **Not the government of Morocco.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Moroccan-licensed counsel
...
(ISO 3166 `MAR`). Required capabilities:
