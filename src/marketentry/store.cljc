(ns marketentry.store
  "SSoT for the MAR market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems MA" :portal "marchespublics.gov.ma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ma-entity? true :has-ma-entity? true
             :requires-ice? true :ice-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MAR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "marchespublics.gov.ma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ma-entity? true :has-ma-entity? true
             :requires-ice? true :ice-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "marchespublics.gov.ma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "MAR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "marchespublics.gov.ma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ma-entity? true :has-ma-entity? false
             :requires-ice? true :ice-verified? true
             :drafted? false :submitted? false
             :jurisdiction "MAR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "marchespublics.gov.ma"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-ma-entity? true :has-ma-entity? true
             :requires-ice? true :ice-verified? false
             :drafted? false :submitted? false
             :jurisdiction "MAR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "marchespublics.gov.ma"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-ma-entity? has-ma-entity?
                               requires-ice? ice-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-ma-entity?)  (assoc :engagement/requires-ma-entity? requires-ma-entity?)
    (some? has-ma-entity?)       (assoc :engagement/has-ma-entity? has-ma-entity?)
    (some? requires-ice?)    (assoc :engagement/requires-ice? requires-ice?)
    (some? ice-verified?)    (assoc :engagement/ice-verified? ice-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-ma-entity? :engagement/has-ma-entity?
   :engagement/requires-ice? :engagement/ice-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-ma-entity? (boolean (:engagement/requires-ma-entity? m))
     :has-ma-entity? (boolean (:engagement/has-ma-entity? m))
     :requires-ice? (boolean (:engagement/requires-ice? m))
     :ice-verified? (boolean (:engagement/ice-verified? m))
